...
botao_2 = Button(frame_corpo, text='%', width=5, height=2, bg=cor5, fg=cor2)
botao_2.place(x=90, y=0)

botao_3 = Button(frame_corpo, text='/', width=5, height=2, bg=cor5, fg=cor2)
